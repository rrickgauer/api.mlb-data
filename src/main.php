...
switch ($p1->getModule()) {
  ...
  case Constants::Modules['Batting']:
    $results = new Batting($p1->getFilters(), $p1->getSorts(), Constants::Defaults['PerPage'], 0, $p1->getAggregate()); break;
  ...
  case Constants::Modules['Appearances']:
    $results = new Appearances($p1->getFilters(), $p1->getSorts(), Constants::Defaults['PerPage'], 0, $p1->getAggregate()); break;
  case Constants::Modules['FieldingOF']:
    $results = new FieldingOF($p1->getFilters(), $p1->getSorts(), Constants::Defaults['PerPage'], 0, $p1->getAggregate()); break;
  case Constants::Modules['FieldingOFSplit']:
    $results = new FieldingOFSplit($p1->getFilters(), $p1->getSorts(), Constants::Defaults['PerPage'], 0, $p1->getAggregate()); break;
  case Constants::Modules['Salaries']:
    $results = new Salaries($p1->getFilters(), $p1->getSorts(), Constants::Defaults['PerPage'], 0, $p1->getAggregate()); break;
  case Constants::Modules['People']:
    $results = new People($p1->getFilters(), $p1->getSorts(), Constants::Defaults['PerPage'], 0, $p1->getAggregate()); break;
